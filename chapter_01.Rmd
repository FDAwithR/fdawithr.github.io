...
## load NHANES data
data <- readRDS("./../../FDA-with-R/NHANES/data/nhanes_fda_with_r_ml.rds") ## need to change once deciding where to put NHANES data
...
nhanes_lite <- readRDS("./../../FDA-with-R/NHANES/data/nhanes_fda_with_r.rds")
